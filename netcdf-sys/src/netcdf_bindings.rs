...
extern "C" {
    ...
    pub fn nc_inq_grps(
        ncid: ::libc::c_int,
        numgrps: *mut ::libc::c_int,
        ncids: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_grpname(ncid: ::libc::c_int, name: *mut ::libc::c_char) -> ::libc::c_int;
    pub fn nc_inq_grpname_full(
        ncid: ::libc::c_int,
        lenp: *mut usize,
        full_name: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_inq_grpname_len(ncid: ::libc::c_int, lenp: *mut usize) -> ::libc::c_int;
    pub fn nc_inq_grp_parent(ncid: ::libc::c_int, parent_ncid: *mut ::libc::c_int)
        -> ::libc::c_int;
    pub fn nc_inq_grp_ncid(
        ncid: ::libc::c_int,
    ...
    pub fn nc_inq_varids(
        ncid: ::libc::c_int,
        nvars: *mut ::libc::c_int,
        varids: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_dimids(
        ncid: ::libc::c_int,
        ndims: *mut ::libc::c_int,
        dimids: *mut ::libc::c_int,
        include_parents: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_typeids(
        ncid: ::libc::c_int,
        ntypes: *mut ::libc::c_int,
        typeids: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_type_equal(
        ...
        ncid2: ::libc::c_int,
        typeid2: nc_type,
        equal: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_def_grp(
        parent_ncid: ::libc::c_int,
        name: *const ::libc::c_char,
        new_ncid: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_rename_grp(grpid: ::libc::c_int, name: *const ::libc::c_char) -> ::libc::c_int;
    ...
    pub fn nc_inq_compound_name(
        ncid: ::libc::c_int,
        xtype: nc_type,
        name: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_inq_compound_size(
        ncid: ::libc::c_int,
        xtype: nc_type,
        sizep: *mut usize,
    ) -> ::libc::c_int;
    pub fn nc_inq_compound_nfields(
        ncid: ::libc::c_int,
        xtype: nc_type,
        nfieldsp: *mut usize,
    ) -> ::libc::c_int;
    ...
    pub fn nc_free_vlens(len: usize, vlens: *mut nc_vlen_t) -> ::libc::c_int;
    pub fn nc_put_vlen_element(
        ncid: ::libc::c_int,
        typeid1: ::libc::c_int,
        vlen_element: *mut ::libc::c_void,
        len: usize,
    ...
    pub fn nc_free_string(len: usize, data: *mut *mut ::libc::c_char) -> ::libc::c_int;
    ...
    pub fn nc_def_var_fletcher32(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        fletcher32: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_var_fletcher32(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
    ...
    pub fn nc_inq_var_fill(
        ...
        fill_valuep: *mut ::libc::c_void,
    ) -> ::libc::c_int;
    pub fn nc_def_var_endian(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        endian: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_var_endian(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        endianp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_set_fill(
        ncid: ::libc::c_int,
        fillmode: ::libc::c_int,
        old_modep: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_set_default_format(
        format: ::libc::c_int,
        old_formatp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_set_chunk_cache(
        size: usize,
        nelems: usize,
    ...
    pub fn nc_inq(
        ncid: ::libc::c_int,
        ndimsp: *mut ::libc::c_int,
        nvarsp: *mut ::libc::c_int,
        nattsp: *mut ::libc::c_int,
        unlimdimidp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_ndims(ncid: ::libc::c_int, ndimsp: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_nvars(ncid: ::libc::c_int, nvarsp: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_natts(ncid: ::libc::c_int, nattsp: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_unlimdim(ncid: ::libc::c_int, unlimdimidp: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_unlimdims(
        ncid: ::libc::c_int,
        nunlimdimsp: *mut ::libc::c_int,
        unlimdimidsp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_format(ncid: ::libc::c_int, formatp: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_format_extended(
        ncid: ::libc::c_int,
        formatp: *mut ::libc::c_int,
        modep: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_def_dim(
        ncid: ::libc::c_int,
        name: *const ::libc::c_char,
    ...
    pub fn nc_inq_dimname(
        ncid: ::libc::c_int,
        dimid: ::libc::c_int,
        name: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_inq_dimlen(
        ncid: ::libc::c_int,
        dimid: ::libc::c_int,
        lenp: *mut usize,
    ) -> ::libc::c_int;
    pub fn nc_rename_dim(
        ncid: ::libc::c_int,
        dimid: ::libc::c_int,
        name: *const ::libc::c_char,
    ) -> ::libc::c_int;
    ...
    pub fn nc_put_att_double(
        ...
        xtype: nc_type,
        len: usize,
        op: *const ::libc::c_double,
    ) -> ::libc::c_int;
    pub fn nc_get_att_double(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        name: *const ::libc::c_char,
        ip: *mut ::libc::c_double,
    ) -> ::libc::c_int;
    pub fn nc_put_att_ushort(
        ...
        xtype: nc_type,
        len: usize,
        op: *const ::libc::c_ushort,
    ) -> ::libc::c_int;
    pub fn nc_get_att_ushort(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        name: *const ::libc::c_char,
        ip: *mut ::libc::c_ushort,
    ) -> ::libc::c_int;
    ...
    pub fn nc_inq_varname(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        name: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_inq_vartype(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        xtypep: *mut nc_type,
    ) -> ::libc::c_int;
    pub fn nc_inq_varndims(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ndimsp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_vardimid(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        dimidsp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_inq_varnatts(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        nattsp: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_rename_var(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        name: *const ::libc::c_char,
    ) -> ::libc::c_int;
    ...
    pub fn nc_put_var_text(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_get_var_text(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_put_var_uchar(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_uchar,
    ) -> ::libc::c_int;
    pub fn nc_get_var_uchar(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_uchar,
    ) -> ::libc::c_int;
    pub fn nc_put_var_schar(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_get_var_schar(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_put_var_short(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_short,
    ) -> ::libc::c_int;
    pub fn nc_get_var_short(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_short,
    ) -> ::libc::c_int;
    pub fn nc_put_var_int(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_get_var_int(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn nc_put_var_long(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_long,
    ) -> ::libc::c_int;
    pub fn nc_get_var_long(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_long,
    ) -> ::libc::c_int;
    pub fn nc_put_var_float(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_float,
    ) -> ::libc::c_int;
    pub fn nc_get_var_float(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_float,
    ) -> ::libc::c_int;
    pub fn nc_put_var_double(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_double,
    ) -> ::libc::c_int;
    pub fn nc_get_var_double(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_double,
    ) -> ::libc::c_int;
    pub fn nc_put_var_ushort(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_ushort,
    ) -> ::libc::c_int;
    pub fn nc_get_var_ushort(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_ushort,
    ) -> ::libc::c_int;
    pub fn nc_put_var_uint(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_uint,
    ) -> ::libc::c_int;
    pub fn nc_get_var_uint(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_uint,
    ) -> ::libc::c_int;
    pub fn nc_put_var_longlong(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_longlong,
    ) -> ::libc::c_int;
    pub fn nc_get_var_longlong(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_longlong,
    ) -> ::libc::c_int;
    pub fn nc_put_var_ulonglong(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_ulonglong,
    ) -> ::libc::c_int;
    pub fn nc_get_var_ulonglong(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_ulonglong,
    ) -> ::libc::c_int;
    pub fn nc_put_var_string(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *mut *const ::libc::c_char,
    ) -> ::libc::c_int;
    pub fn nc_get_var_string(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut *mut ::libc::c_char,
    ) -> ::libc::c_int;
    ...
    pub fn nc_put_var_ubyte(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        op: *const ::libc::c_uchar,
    ) -> ::libc::c_int;
    pub fn nc_get_var_ubyte(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        ip: *mut ::libc::c_uchar,
    ) -> ::libc::c_int;
    ...
    pub fn nc_delete_mp(path: *const ::libc::c_char, basepe: ::libc::c_int) -> ::libc::c_int;
    pub fn nc_set_base_pe(ncid: ::libc::c_int, pe: ::libc::c_int) -> ::libc::c_int;
    pub fn nc_inq_base_pe(ncid: ::libc::c_int, pe: *mut ::libc::c_int) -> ::libc::c_int;
    pub fn nctypelen(datatype: nc_type) -> ::libc::c_int;
    pub fn nc_advise(
        cdf_routine_name: *const ::libc::c_char,
        err: ::libc::c_int,
        fmt: *const ::libc::c_char,
        ...
    ) -> ();
    pub fn nccreate(path: *const ::libc::c_char, cmode: ::libc::c_int) -> ::libc::c_int;
    pub fn ncopen(path: *const ::libc::c_char, mode: ::libc::c_int) -> ::libc::c_int;
    pub fn ncsetfill(ncid: ::libc::c_int, fillmode: ::libc::c_int) -> ::libc::c_int;
    ...
    pub fn ncdimid(ncid: ::libc::c_int, name: *const ::libc::c_char) -> ::libc::c_int;
    pub fn ncdiminq(
        ncid: ::libc::c_int,
        dimid: ::libc::c_int,
        name: *mut ::libc::c_char,
        lenp: *mut ::libc::c_long,
    ) -> ::libc::c_int;
    pub fn ncdimrename(
        ncid: ::libc::c_int,
        dimid: ::libc::c_int,
    ...
    pub fn ncvarid(ncid: ::libc::c_int, name: *const ::libc::c_char) -> ::libc::c_int;
    pub fn ncvarinq(
        ncid: ::libc::c_int,
        varid: ::libc::c_int,
        name: *mut ::libc::c_char,
    ...
    pub fn ncrecinq(
        ncid: ::libc::c_int,
        nrecvarsp: *mut ::libc::c_int,
        recvaridsp: *mut ::libc::c_int,
        recsizesp: *mut ::libc::c_long,
    ) -> ::libc::c_int;
    pub fn ncrecget(
        ncid: ::libc::c_int,
        recnum: ::libc::c_long,
